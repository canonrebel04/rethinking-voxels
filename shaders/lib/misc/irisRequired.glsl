...
// ⚡ Bolt: Extracted complex expression and replaced pow(x, 2.0) with manual multiplication for faster execution
float lenTerm = (len - 0.35) / 0.5;
int colorIndex = int(floor(fract(angle / 2.0 / PI - (lenTerm * lenTerm) * 0.3) * 16.0));
