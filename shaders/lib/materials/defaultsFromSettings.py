...
if __name__ == '__main__':
    ...
    if (inPlace):
        print("Only change default values in-place if you know what you are doing. It is recommended to back up your shaderpack before changing default values in-place because this overwrites shader files.\nDo you know what you are doing? (y/N)")
        response = input()
